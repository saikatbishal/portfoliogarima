const resume = {
  ...
  softwareSkills: {
    ...
    automationTestingTools: ["Selenium WebDriver", "WebDriverIO", "TestNG"],
    ...
    performanceTesting: ["JMeter (Beginner)"],
  ...
  experience: [
    {
      company: "Lumine Software Solutions, India",
  ...
  qualifications: [
    "MA (Master of Arts) from Annamalai University, Tamil Nadu (2014-2016)",
  ],
  achievements: [
    "Received Star Performer award for exemplary communication and quality focus during a critical project phase, as recognized by both management and clients.",
    "Led the pilot rollout of a new defect triage process, resulting in a 20% reduction in time-to-resolution for high-priority bugs on key releases.",
    "Handpicked to represent the QA team in cross-functional meetings with client stakeholders, resulting in clearer requirement alignment and reduced change requests.",
  ],
};
